...
contract DeployMerkleAirdrop is Script {
    ...
    function deployMerkleAirdrop() public returns (MerkleAirdrop, SushiToken) {
        vm.startBroadcast();
        SushiToken token = new SushiToken();
    ...
    function run() external returns (MerkleAirdrop, SushiToken) {
